    ...
    <AppLayout>
      <div className="page-wrapper page-wrapper-sm space-y-6">
        {carregando ? (
          ...
          <>
            {(() => { const idade = calcularIdade(perfil?.dataNascimento); return (
              <>
                ...
                <section className="card overflow-hidden">
                  <div
                    className="h-24"
                    style={{ background: 'linear-gradient(135deg, rgba(var(--success),0.12), rgba(var(--primary),0.10))' }}
                  />
                      ...
                      <div className="flex items-end gap-4">
                        {perfil.foto ? (
                          ...
                          <div
                            ...
                            style={{ background: 'linear-gradient(135deg, rgb(var(--success)), rgb(var(--primary)))' }}
                          >
